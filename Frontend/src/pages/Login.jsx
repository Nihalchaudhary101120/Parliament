...
export default function Login() {
    ...
    const onSubmit = async (e) => {
        ...
        // ✅ no navigate here — AuthContext handles it with the intended destination
    };
                    ...
                    <div className="auth-footer">
                        <button
                            ...
                            onClick={() => navigate('/signup', {
                                state: { from: location.state?.from }  // ← pass destination forward to signup too
                            })}
                        >
                            Create account
                        </button>
                        ...
                        >
                            {loding ? "Entering..." : "Continue as Guest"}
                        </button>
                    </div>
                </div>
            </div>
